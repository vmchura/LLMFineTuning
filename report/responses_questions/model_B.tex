...
The trucks are regularly checked for mechanical failures and wear on parts. However, in worst cases, they may be [requiring urgent maintenance to maintain normal service operation].
...
Currently, the service has 40\% men and 60\% women working for various tasks, such as [logistics support and security].
...
The areas with the highest waste generation include the central part of Olot, particularly in the city center and on [secondary roads, but there are also areas in commercial districts and satellite towns that generate large amounts of waste].
...
Street cleaning is carried out using a manual trowel [cleaning] mechanism [multiple times. However, recently drones and AI technology have also been used for inspection].
...
Several campaigns have been implemented to improve selective waste collection in Olot, including fines [distribution] system [(fine distribution system), urban resident education activities, etc., but it is still not possible to fully achieve the goal of optimizing collection effectiveness].
\end{enumerate}